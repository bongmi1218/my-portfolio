			...
			<div id="wrapper">
				...
				<!-- Intro -->
					<section class="intro">
						<header>
							<h1>미소짓는 개발자</h1>
							<p>If you can dream it, you can do it.<a href="https://twitter.com/ajlkn">@ajlkn</a> / <a href="https://html5up.net">HTML5 UP</a></p>
							<ul class="actions">
							...
							<ul class="items">
								...
								<li>
									...
									<ul class="icons">
										<li><a href="#" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
										<li><a href="#" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li>
										<li><a href="https://Instagram.com/languor98" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
										<li><a href="#" class="icon brands fa-linkedin-in"><span class="label">LinkedIn</span></a></li>
										<li><a href="https://github.com/bongmi1218" class="icon brands fa-github"><span class="label">GitHub</span></a></li>
